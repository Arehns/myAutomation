...
public class GoogleWebTests {
    ...
    public void googlesearch() {
        ...
        assertEquals(driver.findElement(By.cssSelector(".hlcw0c:nth-child(1) > .g:nth-child(1) .LC20lb")).getText(), is("Google Assistent – Appar på Google Play"));
        driver.close();
    }
}